...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-1.png[One] Log in and set up Cloud Manager

[role="quick-margin-para"]
You should have gotten started with Cloud Manager, which includes logging in, setting up an account, and possibly deploying a Connector and creating working environments.
...
[role="quick-margin-list"]
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/concept-overview.html[Learn how to get started with Cloud Manager^]
