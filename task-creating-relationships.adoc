...
+
If BlueXP copy and sync is unable to retrieve the exports, click *Add Export Manually* and enter the name of an NFS export.
+
...
Sync Timeout:: Define whether BlueXP copy and sync should cancel a data sync if the sync hasn't completed in the specified number of hours or days.
...
BlueXP copy and sync is integrated with Cloud Data Sense. From within Data Sense, you can select the source files that you'd like to sync to a target location using BlueXP copy and sync.
...
https://docs.netapp.com/us-en/bluexp-classification/task-managing-highlights.html#copying-and-synchronizing-source-files-to-a-target-system[Learn how to start a sync relationship from Cloud Data Sense^].
