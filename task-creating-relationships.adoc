...
Exclude Directory Names:: Specify a maximum of 15 directories to exclude from the sync by typing their name and pressing *Enter*. 
+
NOTE: The .copy-offload, .snapshot, ~snapshot directories are excluded by default. If you would like to include these in your sync, please contact us.
