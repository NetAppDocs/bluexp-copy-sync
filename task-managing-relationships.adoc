...
. If you want to receive notifications by email for sync relationships that have the "Failed to Sync" or "Running Continuously" status, click *Settings > Alerts and Notifications Settings*.
