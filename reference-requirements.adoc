...
* An email address that has access to the Google Drive location where you want to sync data
* A Google Cloud service account that has permissions to access Google Drive
* A private key for the service account

To set up the service account, follow the instructions on the following two pages in Google documentation:

* https://developers.google.com/admin-sdk/directory/v1/guides/delegation[Create the service account and credentials^]
* https://developers.google.com/admin-sdk/directory/v1/guides/delegation[Delegate domain-wide authority to your service account^]
